...
**Проверка.** Ad-hoc Debug-сборка (без подписи, рецепт из `SIGNING.md`) — **BUILD SUCCEEDED** под Xcode 16.0. Release не собирали, **деплоя не было**, `/Applications/Stats.app` остаётся на билде 827.
